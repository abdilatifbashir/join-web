...
const Register = ({ data }) => {
  ...
  //     'token',
  //     'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiI4MyIsImV4cCI6MTE5MzkyNjA0MzU3NjJ9.EExDjwomdi8T9iJzFFVOt4a73Yyrd5oXhWRllP0x9fUcULtLbXw_KVKbTVFq39BlWaD12H3f_Xsc4jhOuYN9iA'
  //   );
  // }
  useEffect(() => {
